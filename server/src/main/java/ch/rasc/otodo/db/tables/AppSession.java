...
public class AppSession extends TableImpl<AppSessionRecord> {
     ...
     */
    public final TableField<AppSessionRecord, String> ID = createField("id", org.jooq.impl.SQLDataType.CHAR(35).nullable(false), this, "");

    /**
     * The column <code>app_session.app_user_id</code>.
     */
    public final TableField<AppSessionRecord, Long> APP_USER_ID = createField("app_user_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>app_session.last_access</code>.
     */
    public final TableField<AppSessionRecord, LocalDateTime> LAST_ACCESS = createField("last_access", org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("current_timestamp()", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>app_session.ip</code>.
     */
    public final TableField<AppSessionRecord, String> IP = createField("ip", org.jooq.impl.SQLDataType.VARCHAR(39).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>app_session.user_agent</code>.
     */
    public final TableField<AppSessionRecord, String> USER_AGENT = createField("user_agent", org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
